...
<center>
  ...
  <tr>
    <th  style="text-align:left;"><b>Booking Number</b></th>
    <th style="text-align:left;">Full Name</th>
    <th style="text-align:left;">Email</th>
    <th style="text-align:left;">Mobile</th>
    <th style="text-align:left;">Date</th>
    <th style="text-align:left;">Couple name</th>
    <th style="text-align:left;">Hall</th>
    <th style="text-align:left;">Menu</th>
    <th style="text-align:left;">Beverge</th>
    <th style="text-align:left;">Car</th>
    <th style="text-align:left;">Table</th>
    <th style="text-align:left;">Poruwa</th>
    <th style="text-align:left;">Dance</th>
    <th style="text-align:left;">Music</th>
    <th style="text-align:left;">Jayamangala</th>
...
<?php
   ...
   if($result->num_rows>0){
     while($row=$result->fetch_assoc()){
       echo"<tr><td>".$row["bookid"]."</td><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["mobile"]."</td><td>".$row["Res_date"]."</td><td>".$row["couples_name"]."</td><td>".$row["banquet_ID"]."</td><td>".$row["menu"]."</td><td>".$row["beverage"]."</td><td>".$row["car"]."</td><td>".$row["table_chair"]."</td><td>".$row["poruwa"]."</td><td>".$row["dancing_G"]."</td><td>".$row["music"]."</td><td>".$row["jayamangala"]."</td><td>".$row["card_no"]."</td><td>".$row["cvc_no"]."</td></tr>";
     }
